...
public class InvList {
  ...
  /**
   *  Get the term location in the n'th document of the inverted list.
   *  @param n The index of the requested document term frequency.
   *  @return The document's term locations.
   */
  public Vector<Integer> getLocations(int n) {
    return this.postings.get(n).positions;
  }
