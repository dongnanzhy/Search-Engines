...
public abstract class Qry {
   ...
   */
  protected String displayName = new String ("Unnamed");
  ...
  /**
   *  Determin if two queries are equal
   *  @return The string version of this query operator.
   */
  @Override public boolean equals(Object q) {
    if (this.args.size() != ((Qry)q).args.size())
      return false;
    if (this.toString().equals(((Qry)q).toString()))
      return true;
    else
      return false;
  }
